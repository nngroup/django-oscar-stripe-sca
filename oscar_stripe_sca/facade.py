...
class Facade(object):
    ...
    def build_session_metadata(self, raw_line_items, session_line_items):
        session_metadata = {
            "scs": "oscar",
    ...
    def prepare_line_items(self, raw_line_items):
        prepared_line_items = []
        ...
        if settings.STRIPE_COMPRESS_TO_ONE_LINE_ITEM:
            ...
            amount = self._convert_to_cents(total.incl_tax, total.currency)
    ...
    def create_checkout_session(
        self, basket, customer_email, shipping_method
    ):
        self.basket = basket
        self.customer_email = customer_email
        self.shipping_method = shipping_method

        raw_line_items = self.get_raw_line_items()
        session_line_items = self.prepare_line_items(raw_line_items)
