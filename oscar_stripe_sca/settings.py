...
STRIPE_PREVIEW_URL = getattr(settings, "STRIPE_PREVIEW_URL", None)
STRIPE_WEBHOOK_URL = getattr(settings, "STRIPE_WEBHOOK_URL", None)
STRIPE_WAITING_URL = getattr(settings, "STRIPE_WAITING_URL", None)
STRIPE_PAYMENT_CHECK_URL = getattr(settings, "STRIPE_PAYMENT_CHECK_URL", None)
STRIPE_CONFIRM_URL = getattr(settings, "STRIPE_CONFIRM_URL", None)
